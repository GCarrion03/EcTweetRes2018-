...
#####################DELETE INDEX AND RIVER###########################
 #Delete River:
echo "Deleting River"
curl -XDELETE "http://root:Earthb0und@localhost:9500/_river/$INDEX_NAME/"
sleep 5
echo
# #Delete Index:
echo "Deleting Index: $INDEX_NAME ..."
curl -XDELETE "http://root:Earthb0und@localhost:9500/$INDEX_NAME/$INDEX_TYPE"
curl -XDELETE "http://root:Earthb0und@localhost:9500/$INDEX_NAME"
echo
