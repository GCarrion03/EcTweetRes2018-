...
var Modules = {
	...
	search_url: 'http://169.45.220.147:9500/ecuador-index/tweet/_search',
	search_clusters_url: 'http://169.45.220.147:9200/ecuador-index/tweet/_search_with_clusters',
...
//    search_clusters_url: 'http://115.146.93.240:9200/melbourne-index/tweet/_search_with_clusters',
    ...
    id_str_field: "retweeted_status.id_str",
    sentiment_field: "sentiment_analysis.sentiment",
    username_field: "user.screen_name",
    clientId : "111",
    clientSecret : "222",
    search_url_aut: 'http://'+this.clientId+':'+this.clientSecret+'@169.45.220.147:9200/ecuador-index/tweet/_search',
    authorizationBasic : $.base64.btoa(this.clientId + ':' + this.clientSecret),
    
    populateNTweetsLabel: function(query,startDate,endDate){

    	var request = QBuilder.getUniqueAggregationByDate(query,1,"user.id_str",startDate,endDate);
    	...
    	$.ajax({
            ...
            success: function(response) {
                ...
                var hits = "Users: ";
                var res = Helper.numberWithCommas(response.aggregations.distinct_users.value);

                $('#NUsersFound').text(hits + res);
    ...
    populateNUsersLabel: function(query,startDate,endDate){

    	var request = QBuilder.getEmptyAggregation(query,startDate,endDate);
    ...
    populateTop5TrendsGeoLimits: function(query,geoPoints,idTrendsBarChart){
    	...
    	var request = QBuilder.getBasicPolygonAggregation(query,10,this.hashtag_field,geoPoints);
    ...
    populateTop5Trends: function(query,startDate,endDate){

    	var request = QBuilder.getBasicAggregationByDate(query,20,this.hashtag_field,startDate,endDate);
    ...
    populateTopTweets: function(query,startDate,endDate){

    	var request = QBuilder.getTopTweetsAggregation(query,10,startDate,endDate);
    	...
    	$.ajax({
            ...
            data: JSON.stringify(request),
            success: function(response) {
                var title = "Most Retweeted posts created within paremeters";
                var dataChart = Helper.getTopTweetsBarChartData(response,title,'Tweets', "");
                $('#top-tweets-barchart').highcharts(dataChart);
            },
            error: function(jqXHR, textStatus, errorThrown) {
                var jso = jQuery.parseJSON(jqXHR.responseText);
                console.log( jqXHR.status + ':' + errorThrown + ':' + jso.error);
    ...
    populateTopContentGenerators: function(query,startDate,endDate){

    	var request = QBuilder.populateTopContentGenerators(query,20,startDate,endDate);
    	...
    	$.ajax({
            ...
            data: JSON.stringify(request),
            success: function(response) {
                var title = "Users with most retweets";
                var dataChart = Helper.getTopUsersBarChartData(response,title,'Tweets', "@");
                $('#top-contentgens-barchart').highcharts(dataChart);
            },
            error: function(jqXHR, textStatus, errorThrown) {
                var jso = jQuery.parseJSON(jqXHR.responseText);
                console.log( jqXHR.status + ':' + errorThrown + ':' + jso.error);
    ...
    populateTopTweetsStored: function(query,startDate,endDate){

    	var request = QBuilder.getBasicAggregationByDate(query,10,this.id_str_field,startDate,endDate);
    	...
    	$.ajax({
            ...
            success: function(response) {
                ...
                var title = "Top retwetted tweets";

                var dataChart = Helper.getTop5RetweetsBarChartData(response,title,'Tweets', "");

                $('#top-retweet-barchart').highcharts(dataChart);
    ...
    populateTop5Users: function(query,startDate,endDate){

    	var request = QBuilder.getBasicAggregationByDate(query,5,this.username_field,startDate,endDate);
    ...
    populateHistogramTrends: function(query,startDate,endDate){

        var request = QBuilder.getHistogramAggregation(query,startDate,endDate);
    ...
    populateMostProlificTweeter: function(query){
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var title = "Top prolific Tweeterers";
    ...
    populateMostFollowers: function(query,startDate,endDate){

        var request = QBuilder.getFollowerAggregation(query,5,startDate,endDate);
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                var title = "Top Users with most followers";
    ...
    populatePieChartSentiment: function(query,startDate,endDate){

    	var request = QBuilder.getBasicAggregationByDate(query,5,this.sentiment_field,startDate,endDate);
    ...
    populateTweetTime: function(query,startDate,endDate){

        var request = QBuilder.getTweetTimeAggregation(query,startDate,endDate);
    ...
    populateTweetDaySentiment: function(query,startDate,endDate){

        var request = QBuilder.getTweetDaySentimentAggregation(query,startDate,endDate);
